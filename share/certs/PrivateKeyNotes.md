...
unlocked to sign the Thalercoin-Qt.app bundle.
...
allowing somebody to distribute a Thalercoin-Qt.app or thalercoin-qt-setup.exe with a valid
...
that the thalercoin-qt.exe file inside the installer had not been tampered with.
