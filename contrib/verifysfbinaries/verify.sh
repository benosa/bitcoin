...
###   This script attempts to download the signature file SHA256SUMS.asc from thalercoin.org
...
WORKINGDIR="/tmp/thalercoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://thalercoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://thalercoin.org/bin/"
VERSIONPREFIX="thalercoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'thalercoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[thalercoin-]<version>-[rc[0-9]] (example: thalercoin-0.9.2-rc1)"
   echo "wget output:"
