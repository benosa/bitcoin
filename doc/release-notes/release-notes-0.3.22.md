Download URL: https://sourceforge.net/projects/thalercoin/files/Thalercoin/thalercoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 TLR fee schedule (users still pay 0.01 TLR per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #thalercoin00 - #thalercoin99
