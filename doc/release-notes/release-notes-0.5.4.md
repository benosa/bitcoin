Thalercoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/thalercoin/files/Thalercoin/thalercoin-0.5.4/
...
http://gitorious.org/thalercoin/thalercoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Thalercoin-Qt notifications under Growl 1.3.
Increase required age of Thalercoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxThalercoin properly when installing Thalercoin-Qt over it. (Windows)
