Thalercoin Core version 0.9.2.1 is now available from:

  https://thalercoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 TLR to 0.01 TLR
...
- Fix "Start thalercoin on system login"
