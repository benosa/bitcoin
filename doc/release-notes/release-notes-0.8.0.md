Thalercoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/thalercoin/files/Thalercoin/thalercoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Thalercoin
...
New/changed settings (command-line or thalercoin.conf file)
--------------------------------------------------------
