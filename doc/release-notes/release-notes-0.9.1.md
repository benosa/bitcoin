Thalercoin Core version 0.9.1 is now available from:

  https://thalercoin.org/bin/0.9.1/
...
thalercoind from any pre-0.9.1 version, and have enabled SSL for RPC and
...
installer (on Windows) or just copy over /Applications/Thalercoin-Qt (on Mac) or
thalercoind/thalercoin-qt (on Linux).
...
- Upgrade OpenSSL to 1.0.1g. This release fixes the following vulnerabilities which can
  affect the Thalercoin Core software:
