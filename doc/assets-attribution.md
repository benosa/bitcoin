The following is a list of assets used in the thalercoin source and their proper attribution.
...
* License: MIT
* Site: [https://thalercointalk.org/index.php?topic=15276.0](https://thalercointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original thalercoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/thalercoin.icns, src/qt/res/src/thalercoin.svg,
	src/qt/res/src/thalercoin.ico, src/qt/res/src/thalercoin.png,
	src/qt/res/src/thalercoin_testnet.png, docs/thalercoin_logo_doxygen.png,
