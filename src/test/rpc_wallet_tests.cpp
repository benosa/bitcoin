// Copyright (c) 2013-2014 The Thalercoin Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
	...
	CThalercoinAddress demoAddress = CThalercoinAddress(CTxDestination(demoPubkey.GetID()));
	Value retValue;
	...
	BOOST_CHECK(CThalercoinAddress(retValue.get_str()).Get() == demoAddress.Get());
	...
	BOOST_CHECK(CThalercoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
