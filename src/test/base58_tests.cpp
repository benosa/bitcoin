// Copyright (c) 2011-2014 The Thalercoin Core developers
...
BOOST_AUTO_TEST_CASE(base58_keys_valid_parse)
{
    ...
    BOOST_FOREACH(Value& tv, tests)
    {
        ...
        if(isPrivkey)
        {
            ...
            // Note: CThalercoinSecret::SetString tests isValid, whereas CThalercoinAddress does not!
