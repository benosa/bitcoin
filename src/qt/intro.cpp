...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/thalercoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Thalercoin"),
     ...
     * override -datadir in the thalercoin.conf file in the default data directory
     * (to be consistent with thalercoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
